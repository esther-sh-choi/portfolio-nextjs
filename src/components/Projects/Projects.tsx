      ...
      <div className="h-full max-w-[1240px] w-[75%] lg:w-[50%] lg:mr-20 px-2 py-16 md:pb-32 z-20 mx-auto relative flex flex-col justify-center">
        ...
        <div className="max-h-[60vh] md:max-h-auto overflow-y-scroll mt-2 md:mt-4 grid md:grid-cols-2 lg:grid-cols-3 gap-4 bg-[#ff738b] bg-opacity-70 p-4 shadow-xl rounded-xl">
          {projects.map((project) => (
            <div
              key={project.id}
              className="flex flex-col items-center justify-center w-full shadow-lg rounded-xl group bg-white hover:bg-gradient-to-r from-orange-300 to-yellow-200 hover:cursor-pointer overflow-hidden min-h-[200px]"
