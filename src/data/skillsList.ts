import auth0 from "../../public/skills/auth0.png";
...
import puppeteer from "../../public/skills/puppeteer.png";
import rails from "../../public/skills/rails.png";
import rbd from "../../public/skills/rbd.png";
...
export const skills = [
  { id: "html", name: "HTML", src: html },
  { id: "css", name: "CSS", src: css },
  { id: "sass", name: "Sass", src: sass },
  { id: "js", name: "JavaScript", src: js },
  { id: "ts", name: "TypeScript", src: typescript },
  { id: "react", name: "React", src: react },
  { id: "node", name: "Node.js", src: nodejs },
  { id: "postgresql", name: "PostgreSql", src: postgresql },
  { id: "mui", name: "Material UI", src: mui },
  { id: "tailwind", name: "Tailwind", src: tailwind },
  { id: "bootstrap", name: "Bootstrap", src: bootstrap },
